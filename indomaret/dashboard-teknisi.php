        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                  <li>
                      <a href="dashboard-admin.php"><i class="fa fa-dashboard"></i> Dashboard Admin </a>
                  </li>
                  <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="dashboard-admin.php">Dashboard Admin</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-table"></i> Teknisi
                            </li>
                        </ol>
                    </div>
                </div>
